    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <form role="form" action="{{ route('blogger.update', $blogger->id) }}" method="POST">
                    @csrf
                    <div class="form-floating mb-3">
                        <input type="text"
                            class="form-control @error('name') is-invalid
                    @enderror"
                            id="floatingnameInput" placeholder="Name" name="name" value=" {{ $blogger->name }} ">
                    ...
                    is-invalid
                    @enderror"
                            id="floatingnameInput" placeholder="Email" name="email" value=" {{ $blogger->email }} ">
